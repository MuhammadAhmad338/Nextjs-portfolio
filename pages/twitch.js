...
import netflixImg from '../public/assets/projects/twitch.jpg';
...
const Twitch = () => {
  return (
      <div id="twitch" className='w-full font-nunito font-bold'>
          <div className='w-screen h-[30vh] lg:h-[40vh] relative '>
              <div className='absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh] bg-black/80 z-10'>
                  <Image className='absolute z-1' src={netflixImg} alt='/' fill='fill' objectFit='cover' />
